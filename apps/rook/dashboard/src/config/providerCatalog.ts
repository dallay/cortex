...
/** Backend `ProviderKind` enum (5 values, stable). */
...
export interface CatalogEntry {
  ...
  /** i18n key for the display name (e.g. `'providers.kind.openai'`). */
...
export const PROVIDER_KINDS: readonly CatalogEntry[] = [
  {
    kind: 'openai',
    displayNameKey: 'providers.kind.openai',
    category: 'api-key',
  ...
  {
    kind: 'anthropic',
    displayNameKey: 'providers.kind.anthropic',
    category: 'api-key',
  ...
  {
    kind: 'gemini',
    displayNameKey: 'providers.kind.gemini',
    category: 'api-key',
  ...
  {
    kind: 'groq',
    displayNameKey: 'providers.kind.groq',
    category: 'api-key',
  ...
  {
    kind: 'ollama',
    displayNameKey: 'providers.kind.ollama',
    category: 'local',
...
export const CATEGORIES: readonly CategoryDescriptor[] = [
  {
    kind: 'api-key',
    displayNameKey: 'providers.category.apiKey',
    descriptionKey: 'providers.category.apiKey.description',
  },
  {
    kind: 'oauth',
    displayNameKey: 'providers.category.oauth',
    descriptionKey: 'providers.category.oauth.description',
  },
  {
    kind: 'local',
    displayNameKey: 'providers.category.local',
