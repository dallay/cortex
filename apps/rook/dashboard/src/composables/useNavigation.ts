...
const iconRegistry: Record<string, () => Promise<Component>> = {
  CircleDot: () => import('@lucide/vue/dist/esm/icons/circle-dot.mjs').then(m => m.default),
  FileSliders: () => import('@lucide/vue/dist/esm/icons/file-sliders.mjs').then(m => m.default),
  Globe: () => import('@lucide/vue/dist/esm/icons/globe.mjs').then(m => m.default),
  Home: () => import('@lucide/vue/dist/esm/icons/house.mjs').then(m => m.default),
  Key: () => import('@lucide/vue/dist/esm/icons/key.mjs').then(m => m.default),
  LifeBuoy: () => import('@lucide/vue/dist/esm/icons/life-buoy.mjs').then(m => m.default),
  ListOrdered: () => import('@lucide/vue/dist/esm/icons/list-ordered.mjs').then(m => m.default),
  Send: () => import('@lucide/vue/dist/esm/icons/send.mjs').then(m => m.default),
  Settings: () => import('@lucide/vue/dist/esm/icons/settings.mjs').then(m => m.default),
}

function resolveIcon(name: string): Component {
  const loader = iconRegistry[name]
  if (!loader) {
    console.warn(`[useNavigation] Icon "${name}" not found in registry. Falling back to Home.`)
