...
describe('ProviderIcon', () => {
  ...
  it('sets role=img and aria-label on Iconify svg when not decorative', () => {
    const wrapper = mount(ProviderIcon, {props: {kind: 'openai', decorative: false}})
    const svg = wrapper.find('svg')
  ...
  it('sets role=img and aria-label on local img when not decorative', () => {
    const wrapper = mount(ProviderIcon, {props: {kind: 'groq', decorative: false}})
    const img = wrapper.find('img')
  ...
  it('passes explicit width and height to the Iconify svg', () => {
    const wrapper = mount(ProviderIcon, {props: {kind: 'anthropic', width: 40, height: 40}})
    const svg = wrapper.find('svg')
  ...
  it('passes explicit width and height to the local img', () => {
    const wrapper = mount(ProviderIcon, {props: {kind: 'groq', width: 40, height: 40}})
    const img = wrapper.find('img')
  ...
  it('sets loading="eager" on local img when specified', () => {
    const wrapper = mount(ProviderIcon, {props: {kind: 'groq', loading: 'eager'}})
